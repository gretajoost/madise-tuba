      ...
      <Scene>
        <template v-slot:assets>
          <a-assets>
            ...
            <a-asset-item id="pokemon" src="./assets/models/model.obj"></a-asset-item>
            <a-asset-item id="pokemon-mtl" src="./assets/models/model.mtl"></a-asset-item>
        ...
        <a-entity position="0 1.6 0.089" rotation="-180 -6 -180" scale="0.5 0.5 0.5" class="pokemon" obj-model="obj: #pokemon; mtl: #pokemon-mtl"></a-entity>
        <a-entity position="10 6 0" rotation="0 120 0" scale="10 10 10" class="pokemon" obj-model="obj: #pokemon; mtl: #pokemon-mtl"></a-entity>
        <a-entity position="9 1 0" rotation="0 120 0" scale="2 2 2" class="pokemon" obj-model="obj: #pokemon; mtl: #pokemon-mtl"></a-entity>
